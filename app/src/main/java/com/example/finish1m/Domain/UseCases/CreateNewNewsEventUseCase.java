...
public class CreateNewNewsEventUseCase {
    ...
    public CreateNewNewsEventUseCase(EventRepository eventRepository, ChatRepository chatRepository, ImageRepository imageRepository, Event event, Chat chat, ArrayList<Bitmap> images, OnSetDataListener listener) {
